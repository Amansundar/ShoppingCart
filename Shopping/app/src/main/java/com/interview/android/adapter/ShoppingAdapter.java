...
public class ShoppingAdapter extends ArrayAdapter<ProductObject> {
  ...
  public ShoppingAdapter(Context context,TotalValueListener totalValueListener, ArrayList<ProductObject> items) {
    super(context, R.layout.productitem);
